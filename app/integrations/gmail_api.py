...
class MessageSummary:
    ...
    # Task 11: the internal composer needs to pre-fill a CC field when
    # editing an existing draft/message, same as `to`/`subject` already
    # do. `bcc` is deliberately NOT surfaced here - Gmail never returns
    # Bcc in message headers for anyone but the sender's own copy, and
    # Nova doesn't try to reconstruct it.
    cc: str = ""
